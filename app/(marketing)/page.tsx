...
function ServicesSection() {
  ...
  const hX  = useTransform(scrollYProgress, [0, 0.18, 0.92, 0.99], [-80, 0, 0, -80]);
  const hOp = useTransform(scrollYProgress, [0, 0.12, 0.92, 0.99], [0, 1, 1, 0]);

  /* card 1: enter from left, exit to left */
  const c1X  = useTransform(scrollYProgress, [0.05, 0.24, 0.92, 0.99], [-110, 0, 0, -110]);
  const c1R  = useTransform(scrollYProgress, [0.05, 0.24, 0.92, 0.99], [-2.5, 0, 0, -2.5]);
  const c1Op = useTransform(scrollYProgress, [0.05, 0.18, 0.92, 0.99], [0, 1, 1, 0]);

  /* card 2: enter from below, exit downward */
  const c2Y  = useTransform(scrollYProgress, [0.08, 0.28, 0.92, 0.99], [90, 0, 0, 90]);
  const c2Op = useTransform(scrollYProgress, [0.08, 0.22, 0.92, 0.99], [0, 1, 1, 0]);

  /* card 3: enter from right, exit to right */
  const c3X  = useTransform(scrollYProgress, [0.05, 0.24, 0.92, 0.99], [110, 0, 0, 110]);
  const c3R  = useTransform(scrollYProgress, [0.05, 0.24, 0.92, 0.99], [2.5, 0, 0, 2.5]);
  const c3Op = useTransform(scrollYProgress, [0.05, 0.18, 0.92, 0.99], [0, 1, 1, 0]);
...
function ProcessSection() {
  ...
  const lX  = useTransform(scrollYProgress, [0, 0.2, 0.92, 0.99], [-90, 0, 0, -90]);
  const lOp = useTransform(scrollYProgress, [0, 0.13, 0.92, 0.99], [0, 1, 1, 0]);

  /* right panel — each step staggered enter + exit */
  const s1X  = useTransform(scrollYProgress, [0.06, 0.24, 0.92, 0.99], [90, 0, 0, 90]);
  const s1Op = useTransform(scrollYProgress, [0.06, 0.18, 0.92, 0.99], [0, 1, 1, 0]);
  const s2X  = useTransform(scrollYProgress, [0.1,  0.28, 0.92, 0.99], [90, 0, 0, 90]);
  const s2Op = useTransform(scrollYProgress, [0.1,  0.22, 0.92, 0.99], [0, 1, 1, 0]);
  const s3X  = useTransform(scrollYProgress, [0.14, 0.32, 0.92, 0.99], [90, 0, 0, 90]);
  const s3Op = useTransform(scrollYProgress, [0.14, 0.26, 0.92, 0.99], [0, 1, 1, 0]);
...
function PortfolioSection() {
  ...
  const p1X  = useTransform(scrollYProgress, [0.05, 0.24, 0.92, 0.99], [-110, 0, 0, -110]);
  const p1R  = useTransform(scrollYProgress, [0.05, 0.24, 0.92, 0.99], [-2, 0, 0, -2]);
  const p1Op = useTransform(scrollYProgress, [0.05, 0.18, 0.92, 0.99], [0, 1, 1, 0]);

  const p2Y  = useTransform(scrollYProgress, [0.08, 0.28, 0.92, 0.99], [80, 0, 0, 80]);
  const p2Op = useTransform(scrollYProgress, [0.08, 0.22, 0.92, 0.99], [0, 1, 1, 0]);

  const p3X  = useTransform(scrollYProgress, [0.05, 0.24, 0.92, 0.99], [-110, 0, 0, -110]);
  const p3R  = useTransform(scrollYProgress, [0.05, 0.24, 0.92, 0.99], [-2, 0, 0, -2]);
  const p3Op = useTransform(scrollYProgress, [0.05, 0.18, 0.92, 0.99], [0, 1, 1, 0]);
...
function TestimonialsSection() {
  ...
  const t1X  = useTransform(scrollYProgress, [0.05, 0.24, 0.92, 0.99], [-100, 0, 0, -100]);
  const t1R  = useTransform(scrollYProgress, [0.05, 0.24, 0.92, 0.99], [-2, 0, 0, -2]);
  const t1Op = useTransform(scrollYProgress, [0.05, 0.18, 0.92, 0.99], [0, 1, 1, 0]);

  const t2Y  = useTransform(scrollYProgress, [0.08, 0.28, 0.92, 0.99],  [80, 0, 0, 80]);
  const t2Op = useTransform(scrollYProgress, [0.08, 0.22, 0.92, 0.99], [0, 1, 1, 0]);

  const t3X  = useTransform(scrollYProgress, [0.05, 0.24, 0.92, 0.99], [100, 0, 0, 100]);
  const t3R  = useTransform(scrollYProgress, [0.05, 0.24, 0.92, 0.99], [2, 0, 0, 2]);
  const t3Op = useTransform(scrollYProgress, [0.05, 0.18, 0.92, 0.99], [0, 1, 1, 0]);
